...
namespace VotGESOrders.Web.Models
{
	...
	public class Order : INotifyPropertyChanged
	{
		...
		public OrderTypeEnum OrderType {
			...
			set {
				orderType = value;
				OrderTypeShortName = OrderInfo.Current.OrderTypesShort[orderType];
				OrderTypeName = OrderInfo.Current.OrderTypes[orderType];
			}
		}
		...
		public OrderStateEnum OrderState {
			...
			set {
				orderState = value;
				orderStateStr = OrderInfo.Current.OrderStates[orderState];
			}
		}
