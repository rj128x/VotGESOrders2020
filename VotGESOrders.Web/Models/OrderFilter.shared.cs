...
namespace VotGESOrders.Web.Models
{
	...
	public class OrderFilter : INotifyPropertyChanged
	{
		...
		public static OrderFilter Single { get; set; }


		public Dictionary<FilterDateType, string> DateFilterTypes { get; set; }
		public Dictionary<FilterUserType, string> UserFilterTypes { get; set; }
		public Dictionary<OrderFilterEnum, string> FilterTypes { get; set; }
